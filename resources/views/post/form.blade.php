<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="publicado" class="form-control @error('publicado') is-invalid @enderror" value="{{ old('publicado', $post?->publicado) }}" id="publicado" placeholder="Publicado">
